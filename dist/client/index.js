...
function _getNextAuthUrl() {
  return process.env.NEXTAUTH_URL || (typeof window !== "undefined" ? window.location.origin : undefined);
}

var __NEXTAUTH = {
  baseUrl: (0, _parseUrl.default)(_getNextAuthUrl() || process.env.VERCEL_URL).baseUrl,
  basePath: (0, _parseUrl.default)(_getNextAuthUrl()).basePath,
  baseUrlServer: (0, _parseUrl.default)(process.env.NEXTAUTH_URL_INTERNAL || _getNextAuthUrl() || process.env.VERCEL_URL).baseUrl,
  basePathServer: (0, _parseUrl.default)(process.env.NEXTAUTH_URL_INTERNAL || _getNextAuthUrl()).basePath,
  keepAlive: 0,
  clientMaxAge: 0,
  _clientLastSync: 0,
